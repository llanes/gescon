          ...
          <tr class="${rowClass}">
            ...
            <td>
              <div class="pull-right hidden-phone">
                <a class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" href="javascript:void(0);" title="Eliminar" onclick="deleteItem(${val.idCCE},${val.idCA},${val.idFC},${val.idCF},${val.idM},${val.idT},${total},${val.tipopago})">
...
function deleteItem(id, id2, id3, id4, id5, id6,cantidadRestante,tipopago) {
  Swal.fire({
    title: "¿Estás seguro?",
    ...
    if (result.value) {
      ...
      $.ajax({
        ...
        type: "POST",
        dataType: "JSON",
        data: { id1: id, id2: id2, id3: id3, id4: id4, id5: id5, id6: id6,cantidad:cantidadRestante,tipopago:tipopago },
      })
        .done(function () {
          deuda_e.ajax.reload(); //reload datatable ajax 
