      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
                           <h1 > 
Reportes de Devoluciones de Mercaderias y/o Servicios 
                           </h1>
          <ol class="breadcrumb">
                    ...
                    <form id="view_form" name="view_form" method="post" target="Map" >
                         <div class="box-body">
                          ...
                          <div class='input-group input-group-sm' id='datetimepicker7'>
                              ...
                              <input  type='text' class="form-control " id="fecha2" name="fecha2" value="<?php echo date("d-m-Y");?>"/>
                           ...
                           <div class="form-group col-md-3">
                            ...
                            <div class="input-group input-group-sm">
                              ...
                              <select name="reservation" id="reservation" class="form-control">
                                <option value="1">Devoluciones de Compras</option>
                                <option value="2">Devoluciones de Ventas</option>
                              </select>
                            </div><!-- /.input group -->
                          </div>
