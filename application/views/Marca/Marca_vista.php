              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                   <h3 class="box-title"> 
                    <button id="add" class="btn btn-sm btn-success" onclick="_add()" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                     <i class="fa fa-user-plus" aria-hidden="true" id="tituloboton">&nbsp;Agregar Nueva Marca</i> 
                    </button>
                   </h3>
                <div class="collapse" id="collapseExample">
                  ...
                  <div class="">
                    ...
                    <form action="#" id="from_Marca" class="from_Marca">
                                ...
                                <div class="input-group">
                                  <div class="input-group-addon">
                                    <i class="fa fa-align-center" aria-hidden="true"></i>
                                     ...
                                     <input required title="Se necesita un nombre" maxlength="40" type ="text" id="Marca" name="Marca" class="form-control" autofocus autocomplete="off" placeholder=""  >
                                </div>
                                ...
                                <div class="input-group">
                                  <div class="input-group-addon">
                                    <i class="fa fa-align-center" aria-hidden="true"></i>
                                     ...
                                     <textarea name="Descripcion" id="Descripcion" minlength="5" maxlength="50" class="form-control" autofocus autocomplete="off" placeholder=""  ></textarea>
                                </div>
                 ...
                 <div class="box-tools pull-right">
                       ...
                       <a class="btn btn-info btn-xs" href="javascript:void(0);" title="Exportar a PDF" onclick="pdf_exporte('marca')">
                       <i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a>
                       <a class="btn btn-success btn-xs" href="javascript:void(0);" title="Exportar a EXEL" onclick="exel_exporte('marca')">
                ...
                <div class="box-body">
                  ...
                  <div class="box">
                    <div class="box-body table-responsive no-padding">
                      <table class="table table-striped table-bordered" cellspacing="30" width="100%"  id="tabla_Marca">
                        <thead>
                          <tr>
                               <th ><i class ="fa fa-slack" aria-hidden="true"></i></th>
                               <th ><i class ="ion-ios-copy"></i>  Marca</th>
