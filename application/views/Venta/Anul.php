                ...
                <div class="col-md-12">
                  <!-- AREA CHART -->
                    ...
                    <div class="dt-buttons btn-group">
                                  ...
                                  <a class="btn btn-info btn-xs" href="javascript:void(0);" title="Exportar a PDF" onclick="pdf_exporte('ventanull')">
                                  <i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a>
                                  <a class="btn btn-success btn-xs" href="Reporte_exel/ventanull" title="Exportar a EXEL" >
