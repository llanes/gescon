...
<div role="tabpanel">
  ...
  <ul class="nav nav-tabs nav-justified" role="tablist">
    <li role="presentation" class="active">
      <a id="limpiar" href="#Deudas" aria-controls="Deudas" role="tab" data-toggle="tab"> <i class="fa fa-money"></i> Deudas Cliente</a>
    </li>
    <li role="presentation">
      <a id="clicpagada" href="#pagadas" aria-controls="tab" role="tab" data-toggle="tab"> <i class="fa fa-money"></i> Deudas Cobradas</a>
      ...
      <div role="tabpanel">
        ...
        <form action="pagosdeuda" id="pagosdeuda"  name="pagosdeuda" class='pagosdeuda' method="get" autocomplete="off" accept-charset="utf-8">
          <div class="tab-content">
            ...
            <div class="col-sm-12 invoice-col col-md-offset-0" >
            <div class="table-responsive">
...
<tbody id='detallesRecibos'>
                            ...
                            <div class="form-group-lg">
                                <label for='cheque_tercero'>* Cheque Tercero</label>
                                    <div class="input-group input-lg ">
                                        ...
                                        <input type="text" id="to_chek" value="">
                                    </div>
                                <span class ="NN text-danger"></span>   <!--    INDICADORES DE ERROR A TRAVEZ DE AJAX -->
                            </div>
                        </div>
              ...
              <div class="col-md-8 col-md-offset-0 col-col">
                    ...
                    <div class="form-group-lg col-md-6 col-md-offset-0 col-col">
                      ...
                      <div class="input-group input-lg">
                        ...
                        <input type="text" id="efectivoTarjeta" name="efectivoTarjeta">
            ...
            <div role="tabpanel" class="tab-pane fade" id="fabor">
              ...
              <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                    <h3 class="text-war text-center"> <i class="fa fa-money" aria-hidden="true"></i> Método Saldo a Fabor </h3>
                      ...
                      <!-- <input type="text" name="cobroen" id="cobroen" value="3"> -->
                      <input type="text" name="matriscuanta" id="matriscuanta" value="">
                      <input type="text" name="matris" id="matris" value="">
                  </div>
            </div>
          </div>
          ...
          <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-col">
            ...
            <div class="form-group-lg" >
              <div class="input-group input-lg">
                <div class="input-group-addon input-lg  bor"  >
                  Agregar a Cuenta &nbsp;
                  <input  type="checkbox" name="agregar_cuenta" id="agregar_cuenta" class="controlajustar" value="" >&nbsp;<span class="text-danger" id="valor"></span>&nbsp;₲.
        ...
        <input type="hidden" name="cuotaPrecio" id="cuotaPrecio" value="">
...
<!-- modal off -->
              ...
              <div class="col-md-12">
                <!-- AREA CHART -->
                  <div class="box box-primary">
                      ...
                      <div class="dt-buttons btn-group">
                                  <div class="hidden-phone">
                                  <a class="btn btn-info btn-xs" href="javascript:void(0);" title="Exportar a PDF" onclick="pdf_exporte('lispagadas')">
                                  <i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a>
                                  <a class="btn btn-success btn-xs" href="Reporte_exel/lispagadas" title="Exportar a EXEL">
  ...
  <div class="pull-right hidden-phone" >
    <a data-toggle="tooltip" data-placement="top" href="#" id="cobrarSeleccionados" style="font-size: 12px;" class="btn btn-success btn-xs" >
      <i class="fa fa-shopping-cart"></i> Cobrar <span class="minicart-amount" id="cantidadSeleccionada">0</span>
    </a>
  </div>
</th>
