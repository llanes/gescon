...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1 class="">
      Listados de Ventas
      <!-- <i class="" id="accion" aria-hidden="true">&nbsp;&nbsp;Ventas</i>  -->
    </h1>
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-tools pull-left">
            ...
            <form id="listaVentas" class="form-inline">
          ...
          <div class="box-tools pull-right">
            <div class="dt-buttons btn-group">
              <div class="hidden-phone">
                <a class="btn btn-info btn-xs" href="javascript:void(0);" title="Exportar a PDF" onclick="pdf_exporte('ventas')">
                  <i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a>
                  <a class="btn btn-success btn-xs" href="Reporte_exel/ventas" title="Exportar a EXEL" >
                ...
                <div class="box-body">
                  ...
                  <div class="box">
                    <div class="box-body table-responsive no-padding">
                      ...
                      <table class="table table-striped table-bordered" cellspacing="30" width="100%"  id="tabla_Venta">
                        <thead>
                          <tr>
                          <th ></th>
