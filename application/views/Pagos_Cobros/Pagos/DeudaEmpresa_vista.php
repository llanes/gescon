...
<div role="tabpanel">
       ...
       <h1>
            <small>Deudas Empresa</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li class="active">Cobros</li></li>
            <li class="active">Deudas Empresa</li>
          </ol>
       </section> 
                         <div id="alertasadd" >
  ...
  <ul class="nav nav-tabs nav-justified" role="tablist">
    <li  id="e"  class="text-center">
      <a id="limpiar" href="#Efectivo" aria-controls="Efectivo" role="tab" data-toggle="tab"> <i class="fa fa-money"></i> Cobro Efectivo</a>
    </li>
...
<div class="col-md-4 col-md-offset-0 ">
  ...
  ?>
    ...
    <div role="tabpanel" class="tab-pane" id="fabor">
      <!-- fabor -->
      <!-- FIN fabor -->
    </div>
                      ...
                      <div class="modal-footer modal-footer2">
                          <div class="pull-right">
                             <button  type="submit" id="loadingg" name="add" class="btn btn-sm btn-success" data-loadingg-text="Procesando..." autocomplete="off">
                                    <span class  ="glyphicon glyphicon-floppy-disk" id="btnSave"  >Pagar</span> 
                             </button>&nbsp;&nbsp;
                ...
                <!-- AREA CHART -->
                  <div class="box box-primary">
                     ...
                     <div class="dt-buttons btn-group">
                          ...
                          <a class="btn btn-success btn-xs" href="Reporte_exel/Deuda_e" title="Exportar a EXEL" onclick="exel_exporte('Deuda_e')">
