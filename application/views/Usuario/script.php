<script type='text/javascript'>
    ...
    $(document).ready(function() {
      ...
      $( "#_user" ).addClass( "text-red" );
       tabla_Usuario = $('#tabla_Usuario').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo base_url('index.php/Admin_User/ajax_list'); ?>",
            "type": "POST"
        },
   ...
   function verificar(argument) {
    ...
    function edit_User(id)
    {
      ...
      $.ajax({
        url : "<?php echo base_url('index.php/Admin_User/ajax_edit/'); ?>/" + id,
        type: "GET",
        dataType: "JSON",
    ...
    $(function() {
      $('#from_user').submit(function(e) {
        ...
        if(save_method == 'add_add') 
        {
          url = "<?php echo base_url('index.php/Admin_User/ajax_add'); ?>";
        }
        else
        {
          url = "<?php echo base_url('index.php/Admin_User/ajax_update'); ?>";
        }
          var b = $('#loadingg');
      ...
      function(isConfirm) {
        if (isConfirm) {
            // ajax delete datos de database
                $.ajax({
                  url : "<?php echo base_url('index.php/Admin_User/ajax_delete'); ?>/"+id,
                  type: "POST",
                  dataType: "JSON",
                  cache: false,
                })
