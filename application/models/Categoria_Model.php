...
class Categoria_Model extends CI_Model {
	...
	var $order = array('idCategoria' => 'desc');
    ...
    public function insert(Array $data) {
        if ($this->db->insert(self::CATEGORIA, $data)) {
   	...
   	public function update($where, $data)
	{
		...
		$this->db->update(self::CATEGORIA, $data, $where);
	...
	public function check_Cate($id)
	{
		...
		$consulta = $this->db->get(self::CATEGORIA);
